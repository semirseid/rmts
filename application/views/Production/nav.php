      ...
      <ul class="nav navbar-nav">
        ...
        <li class="dropdown">
          ...
          <ul class="dropdown-menu">
            ...
            <li><a href="<?php echo base_url('production/register');?>"> Register product </a></li>
            <li><a href="<?php echo base_url('/district/AddSegment');?>">  Update products </a></li>
              <li><a href="<?php echo base_url('/district/AddSegment');?>">  production reports </a></li>
          </ul>
        </li>
